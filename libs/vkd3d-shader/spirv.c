...
enum vkd3d_spirv_extension
{
    ...
    VKD3D_SPV_EXT_PHYSICAL_STORAGE_BUFFER       = 0x00000008,
};
...
static const vkd3d_spirv_extensions[] =
{
    ...
    {VKD3D_SPV_EXT_PHYSICAL_STORAGE_BUFFER,     "SPV_EXT_physical_storage_buffer"},
};
...
static const vkd3d_spirv_capability_extensions[] =
{
    ...
    {SpvCapabilityPhysicalStorageBufferAddressesEXT,      VKD3D_SPV_EXT_PHYSICAL_STORAGE_BUFFER},
};
        ...
        struct vkd3d_shader_code *spirv)
{
    ...
    if (vkd3d_spirv_has_capability(builder, SpvCapabilityPhysicalStorageBufferAddressesEXT))
        addressing_model = SpvAddressingModelPhysicalStorageBuffer64EXT;
        ...
        unsigned int flags)
{
    ...
    else if (data_type == VKD3D_DATA_UAV)
    {
        if (binding->flags & VKD3D_SHADER_BINDING_FLAG_COUNTER)
        {
            ...
            type_id = vkd3d_spirv_build_op_type_pointer(builder, SpvStorageClassPhysicalStorageBufferEXT, counter_struct_id);
            ...
            vkd3d_spirv_enable_capability(builder, SpvCapabilityPhysicalStorageBufferAddressesEXT);
        }
        else
        {
            const struct vkd3d_spirv_resource_type *type_info = vkd3d_get_spirv_resource_type(resource_type);
        ...
        const struct vkd3d_shader_instruction *instruction)
{
    ...
    if (binding && (binding->flags & VKD3D_SHADER_BINDING_FLAG_BINDLESS))
    {
        uint32_t ctr_ptr_type_id = vkd3d_spirv_get_op_type_pointer(builder, SpvStorageClassPhysicalStorageBufferEXT, type_id);
